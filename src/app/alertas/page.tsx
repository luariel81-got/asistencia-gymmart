...
import { supabase, GRADOS, TURNOS } from '@/lib/supabase'
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-6 text-center">
          ...
          <p className="text-green-700 font-medium">Sin alertas activas — {turno}</p>
        ...
        <>
          <div className="bg-red-50 border border-red-200 rounded-xl p-3 mb-4 text-sm text-red-700 font-medium">
            ⚠️ {alertas.length} alumno(s) con faltas consecutivas — {turno}
          </div>
